$(document).ready(function() {
    ...
    if (!$('.whatsapp-float').length) {
        $('body').append('<a href="https://wa.me/5515996316527?text=Olá,%20gostaria%20de%20mais%20informações%20sobre%20os%20serviços%20da%20Altalog" target="_blank" class="whatsapp-float" aria-label="Botão atalho WhatsApp"><i class="fab fa-whatsapp"></i></a>');
    }
    ...
    $( ".form-contato-zap" ).on( "submit", function( event ) {
        ...
        var url = "https://wa.me/5515996316527/?text=Olá, sou o(a) " + capitalizeFirstLetter(formData['nome']) + " da(o) " + capitalizeFirstLetter(formData['empresa']) + ",%0A%0AVisitei o site da *Altalog* e gostaria de mais informações sobre:%0A*" + formData['assunto'] + '*%0A%0A' + capitalizeFirstLetter(formData['msg']);
