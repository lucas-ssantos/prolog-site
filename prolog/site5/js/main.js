$(document).ready(function() {
    ...
    $( ".form-contato-zap" ).on( "submit", function( event ) {
        ...
        var url = "https://wa.me/5515996316527/?text=Olá, sou o(a) " + capitalizeFirstLetter(formData['nome']) + " da(o) " + capitalizeFirstLetter(formData['empresa']) + ",%0A%0AVisitei o site da *Prolog* e gostaria de mais informações sobre:%0A*" + formData['assunto'] + '*%0A%0A' + capitalizeFirstLetter(formData['msg']);
